...
public class Test {
    public static void main(String[] args) {
        ...
        Account noExceptionAccount2 = new Account(accountSum2) {
            @Override
            public void change(int delta) throws TryAgainException, BlockAccountException {
                amount = amount + delta;
            }
...
//        testAccounts[2] = noExceptionAccount2;
        testAccounts[2] = blockExceptionAccount;

        // call
        boolean actualResultTransfer = Lab38.transfer(testAccounts, testDelta);
